...
- **<font color=red>ctrl+h</font>**:**全局替换某单词**。先按下ctrl+h，再输入需要全局替换的单词，再点击“全部替换”。
  ...
  ![](images/d78685c8bca0326080987702815272d1b252ed07.png)

- **<font color=red>ctrl+g</font>**：快速**定位到某一行**。先按下ctrl+g，再输入需要定位到的行数，再按下回车即可。
  
  ![](images/18b776dd074711b3aa942aa5d82d54c90955414a.png)

- **<font color=red>shift+alt+拖动鼠标</font>**:选中一个代码区块。
  
  ![](images/b2827ea500f258e3a0fcfc179ecb50b429d71151.png)
  
  此快捷键可**避免**只用拖动鼠标时**选中空格部分**：
  
  ![](images/d6e43f1bba222ede8851cf3a6e1539c7076dce3f.png)

- **<font color=red>自定义快捷键</font>**：
  
  首先，点击”管理“
  
  ![](images/7b637e668e62b8076eccd9a498a67b512e5d9383.png)
  
  其次，点击”键盘快捷方式”
  
  ![](images/88ee85d3e16d24b17b2f810576933049bcbbaa12.png)
  
  接着，打字输入想要更改的快捷键：
  
  ![](images/5209e1c966b357969af20e2fa9b4f76e9c2ad591.png) 
  
  点击需要更改的快捷键，再按照一定次序按下想要更改成的按键（注意：此时是按键盘上的按键，而不是打字输入），即可完成快捷键的更改。
  
  ![](images/d6d80030bd6ec0a687a72cb180e64933d5a01ed5.png)

## 1.4 VSCode在网页中显示运行结果

- 首先，在VSCode的“扩展”中搜索“Live Server”插件并安装：
  
  ![](images/c1e01b855dc53fee073e1a506c0e97802dc76611.png)
...
![](images/83d984c6a5ef4a240e6101168c848eb77917be0d.png)
...
- **4.< div >和< span >标签**
  ...
  - **< div >标签**：
    ...
    - div标签是用于布局的，但是现在一行只能放一个< div >，相当于一个大盒子：
      ...
      ![](images/1a87030abf22b74aa56686ee371384af3bfbac2a.png)
...
- **< span >标签**：
  ...
  - span标签也用于布局，一行上可以有多个span，相当于一个小盒子：
    ...
    ![](images/c509a0fd55df126ce10983d86e3a126fa1681714.png)
...
- **5.图像标签**
  ...
  - **图像标签**
    ...
    - 使用实例：
      ...
      ![](images/f803111762cf608dbc398aac19f7b8269a2bc341.png)
      
      之后，再把图片的文件名复制到引号中：
      
      ![](images/c97e5587565a82c291019071cc241f2f7feb8a53.png)
...
- **7.注释标签和特殊字符**
  ...
  - **特殊字符**：在HTML页面中，一些特殊的符号很难或者不方便直接使用，此时我们就可以使用下面的字符来替代：
    ...
    ![](images/ef8a53769f4f23eccb8926e85b1df4d4ae7698b1.png)
...
- **表单控件（表单元素）**
  ...
  - **< input >表单输入元素**
    ...
    - **<font color=red>type</font>** 的常用属性值：
      ...
      ![](images/029a5562fb4e44ddef430bad857155e6f12aad61.png)
      
      - **radio** 实现单选功能：将选项的name属性赋予相同的属性值。
    
    - 除type属性外,< input >标签还有其他很多属性，常用属性如下：
      
      ![](images/cc188ccf171e31476c84044923880a9e0a856cc3.png)
...
- 基础选择是由**单个选择器组成**的，包括**标签选择器**、**类选择器**、**id选择器**和**通配符选择器**。
  ...
  - **类选择器** 
    ...
    - **语法**：
      ...
      ![](images/e9556e37a163908169a8f4e6b89c3736d4f8e973.png)
...
- 行高的组成：上间距、文本高度、下间距。
  ...
  ![](images/48df30bbe95fb579bf22493e40004d41e00f464f.png)
